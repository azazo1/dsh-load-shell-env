...
function StatusBlock(props) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			status.terminal?.enabled === true && !status.terminal.hooked ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				className: "dsh-lse-invalid",
				children: t("statusTerminalUnavailable")
			}) : null,
	...
	*/
	...
	inject() {
		return {
			...
			setTerminalEnv: (next) => {
				this.setField("terminalEnv", next);
			},
	...
	*/
	...
	effectiveValue(name) {
		...
		switch (name) {
			...
			case "terminalEnv": return value?.terminalEnv ?? true;
	...
	baseValue(name) {
		...
		switch (name) {
			...
			case "terminalEnv": return base?.terminalEnv ?? true;
...
function isFieldName(field) {
	return field === "enabled" || field === "stages" || field === "importNames" || field === "customEnv" || field === "envTimeoutMsText" || field === "filterNoise" || field === "terminalEnv" || field === "timeoutMsText" || field === "maxOutputBytesText";
}
